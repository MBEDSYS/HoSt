 ...
 *         2014 MBEDSYS SAS
 */
public interface HsStackHLayer {
	/**
	 ...
	 *            Stack context
	 */
	void setup(HsStackHLayerContext stackContext) throws Exception;
	 ...
	 */
	void serviceRestore(HsServiceHLayer service);
	 ...
	 */
	boolean serviceAdd(HsServiceHLayer service);
	 ...
	 *            reference to the service
	 */
	void serviceLeave(HsServiceHLayer service);
}
