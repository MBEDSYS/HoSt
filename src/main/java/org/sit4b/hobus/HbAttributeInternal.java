 ...
 *         2014 MBEDSYS SAS
 */
public interface HbAttributeInternal {
	/**
	 ...
	 * @param handler
	 */
	public void setGetValueHandler(HbGetValueHandler handler);
	 ...
	 * @param handler
	 */
	public void setReadHandler(HbRequestHandler handler);
	 ...
	 * @param handler
	 */
	public void setWriteHandler(HbRequestHandler handler);
}
