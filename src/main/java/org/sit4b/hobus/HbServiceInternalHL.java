 ...
 * 
 * <p>
 * This is the high layer accessor to the service used by a {@link HbStackHL}
 ...
 *         2014 MBEDSYS SAS
 */
public interface HbServiceInternalHL {
	 ...
	 */
	HbInterfaceInternal addInterface(String typeName) throws HbException;
	 ...
	 *             other interface exists with the same name and id
	 */
	HbInterfaceInternal addInterface(String typeName, int id)
			throws HbException;
	 ...
	 *         given path
	 */
	HbInterfaceInternal getInterface(String path);
	 ...
	 */
	public Collection<HbInterfaceInternal> interfaces();
	 ...
	 *            the given callback
	 */
	void setRecvClbk(HbCallback<byte[], Exception> callback);
